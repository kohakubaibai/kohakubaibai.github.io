  ...
  $('#sendBtn').click(function () {
    ...
    if (status && email !== '' && food !== '' && mobile !== '' && phone !== '' && last_name !== '' &&
      ...
      if (food == '' || food2=='') {
        $('.errorFood,.errorSubmit')
          .addClass('show')
          .addClass('flash')
      }
      if (mobile == '') {
        $('.errorMobile,.errorSubmit')
          .addClass('show')
          .addClass('flash')
      }
      if (phone == '') {
        $('.errorPhone,.errorSubmit')
          .addClass('show')
          .addClass('flash')
      }
      if (last_name == '') {
      ...
      if (position == '') {
        $('.errorPosition,.errorSubmit')
          .addClass('show')
          .addClass('flash')
      }
      if (department == '') {
        $('.errorDepartment,.errorSubmit')
          .addClass('show')
          .addClass('flash')
      }
      if (!$('#policy').is(':checked')) {
