class NewsFilter {
  ...
  renderPagination() {
    ...
    this.buildPageItems(totalPages).reverse().forEach(item => {
  ...
  updatePrevNext(prevItem, nextItem, totalPages) {
    if (this.currentPage <= 1) {
      ...
      prevItem.innerHTML = '<span class="text"><</span>';
    } else {
      prevItem.classList.remove('is-disabled');
      prevItem.innerHTML = '<a href="#" class="text"><</a>';
    ...
    if (this.currentPage >= totalPages) {
      ...
      nextItem.innerHTML = '<span class="text">></span>';
    } else {
      nextItem.classList.remove('is-disabled');
      nextItem.innerHTML = '<a href="#" class="text">></a>';
